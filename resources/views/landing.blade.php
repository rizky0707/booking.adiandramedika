...
<body class="d-flex flex-column h-100">
  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; {{date('Y')}} - <a href="https://www.indrasatya.com/" target="_blank" class="text-danger text-decoration-none">Klinik Adiandra Medika</a>. All rights reserved.
      </div>
    </div>
  </footer>
  ...
  <script src="https://code.responsivevoice.org/responsivevoice.js?key=9j1bhyge"></script>
  <!-- <script src="https://code.responsivevoice.org/responsivevoice.js?key=jQZ2zcdq"></script> -->

  <script type="text/javascript">
    $(document).ready(function() {
      // tampilkan informasi antrian
      $('#jumlah-antrian').load('getUmum');
    ...
    //   $('#sisa-antrian').load('get_sisa_antrian.php');
      ...
      var table = $('#tabel-antrian').DataTable({
        ...
        "ajax": "getAll",          // url file proses tampil data dari database
        // menampilkan data
        "columns": [{
            "data": "code_antrian",
            "width": '250px',
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian,  " + data["code_antrian"] + ", menuju, loket, A,", "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
      ...
      setInterval(function() {
        $('#jumlah-antrian').load('getUmum').fadeIn("slow");
        // $('#tabel-antrian').fadeIn("slow");
